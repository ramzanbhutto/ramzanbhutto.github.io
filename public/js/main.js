(() => {
  // ns-hugo-imp:/home/ramzan/website/ramzan/themes/FixIt/assets/js/core/banner.ts
  ...
  // ns-hugo-imp:/home/ramzan/website/ramzan/themes/FixIt/assets/js/utils/animation.ts
  ...
  // ns-hugo-imp:/home/ramzan/website/ramzan/themes/FixIt/assets/js/utils/clipboard.ts
  ...
  // ns-hugo-imp:/home/ramzan/website/ramzan/themes/FixIt/assets/js/utils/dom.ts
  ...
  // ns-hugo-imp:/home/ramzan/website/ramzan/themes/FixIt/assets/js/utils/file.ts
  ...
  // ns-hugo-imp:/home/ramzan/website/ramzan/themes/FixIt/assets/js/utils/media.ts
  function isMobile() {
  ...
  // ns-hugo-imp:/home/ramzan/website/ramzan/themes/FixIt/assets/js/utils/string.ts
  ...
  // ns-hugo-imp:/home/ramzan/website/ramzan/themes/FixIt/assets/js/utils/tooltip.ts
  ...
  // ns-hugo-imp:/home/ramzan/website/ramzan/themes/FixIt/assets/js/utils/validate.ts
  function isValidDate(date) {
    return date instanceof Date && !Number.isNaN(date.getTime());
  }

  // ns-hugo-imp:/home/ramzan/website/ramzan/themes/FixIt/assets/js/modules/code.ts
  ...
  // ns-hugo-imp:/home/ramzan/website/ramzan/themes/FixIt/assets/js/modules/content.ts
  ...
  var ContentModule = class {
    ...
    initTooltip() {
      ...
      CellTooltip2.initAll(".fixit-encryptor-btn[title]");
      this.#initFootnotes();
    }
    /**
  ...
  // ns-hugo-imp:/home/ramzan/website/ramzan/themes/FixIt/assets/js/modules/core.ts
  ...
  // ns-hugo-imp:/home/ramzan/website/ramzan/themes/FixIt/assets/js/modules/encryption.ts
  ...
  // ns-hugo-imp:/home/ramzan/website/ramzan/themes/FixIt/assets/js/modules/events.ts
  ...
  // ns-hugo-imp:/home/ramzan/website/ramzan/themes/FixIt/assets/js/modules/menu.ts
  ...
  // ns-hugo-imp:/home/ramzan/website/ramzan/themes/FixIt/assets/js/modules/misc.ts
  ...
  // ns-hugo-imp:/home/ramzan/website/ramzan/themes/FixIt/assets/js/modules/pwa.ts
  var PWAModule = class {
    #core;
    constructor(core) {
      this.#core = core;
  ...
  // ns-hugo-imp:/home/ramzan/website/ramzan/themes/FixIt/assets/js/modules/search/engines/algolia.ts
  ...
  // ns-hugo-imp:/home/ramzan/website/ramzan/themes/FixIt/assets/js/modules/search/engines/cse.ts
  ...
  // ns-hugo-imp:/home/ramzan/website/ramzan/themes/FixIt/assets/js/modules/search/engines/fuse.ts
  ...
  // ns-hugo-imp:/home/ramzan/website/ramzan/themes/FixIt/assets/js/modules/search/engines/pagefind.ts
  ...
  // ns-hugo-imp:/home/ramzan/website/ramzan/themes/FixIt/assets/js/modules/search/index.ts
  ...
  // ns-hugo-imp:/home/ramzan/website/ramzan/themes/FixIt/assets/js/modules/theme.ts
  ...
  // ns-hugo-imp:/home/ramzan/website/ramzan/themes/FixIt/assets/js/modules/toc.ts
  var TOC_CONTAINER_IDS = ["toc-content-auto", "toc-content-static", "toc-content-drawer"];
  var TocModule = class {
    #activeTocId = null;
    /** Get all TOC content containers (auto, static, and drawer). */
    #getTocContainers() {
      return TOC_CONTAINER_IDS.map((id) => document.getElementById(id)).filter(Boolean);
    }
    /**
     ...
     */
    #getActiveTocHeading() {
      const $headingElements = Array.from(document.querySelectorAll(".heading-element[id]"));
      ...
      const breadcrumbOffset = document.querySelector(".breadcrumb-container")?.offsetHeight || 0;
    ...
    syncTocActiveState() {
      ...
      const $tocRoots = this.#getTocContainers().map(($container) => $container.querySelector("nav")).filter(Boolean);
      ...
      if (this.#activeTocId !== activeId) {
        ...
        if (!isTocStatic()) {
          const $autoTocRoot = document.querySelector("#toc-content-auto > nav");
    ...
    #syncTocLayout() {
      document.querySelector("#toc-drawer-button")?.classList.toggle("hidden", !isTocStatic());
    ...
    renderToc() {
      const $tocTemplate = document.querySelector("template[data-toc]");
      ...
      for (const $container of this.#getTocContainers()) {
        ...
        const $clone = $tocCore.cloneNode(true);
  ...
  // ns-hugo-imp:/home/ramzan/website/ramzan/themes/FixIt/assets/js/core/public-api.ts
  var PublicAPI = class {
    core;
    theme;
    code;
